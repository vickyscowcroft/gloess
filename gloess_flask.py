...
input = '/Users/vs522/Dropbox/Python/dotastro/dot-astro-flask-demo/gloess_input/RRLyr.gloess_in'
counter = 0
...
plot = figure(tools=TOOLS, title=titlestring, 
...
if nu > 0:
	...
	plot.line(ux, u1+3., alpha=.2, color='black', size=10)
	plot.circle(xphaseu, yu+3., alpha=.2, color='Violet', size=10)
	#ax1.plot(ux,u1+3.,'k-')
...
if nb > 0:
	...
	plot.line(bx, b1+1.5, alpha=.2, color='black', size=10)
	plot.circle(xphaseb, yb+1.5, alpha=.2, color='MediumSlateBlue', size=10)
...
if nv > 0:
	...
	plot.line(vx, v1+1.2, alpha=.2, color='black', size=10)
	plot.circle(xphasev, yv+1.2, alpha=.2, color='DodgerBlue', size=10)
...
if nr > 0:
	...
	plot.line(rx, r1+0.7, alpha=.2, color='black', size=10)
	plot.circle(xphaser, yr+0.7, alpha=.2, color='Turquoise', size=10)
...
if ni > 0:
	...
	plot.line(ix, i1+0.2, alpha=.2, color='black', size=10)
	plot.circle(xphasei, yi+0.2, alpha=.2, color='LawnGreen', size=10)
...
if nj > 0:
	...
	plot.line(jx, j1, alpha=.2, color='black', size=10)
	plot.circle(xphasej, yj, alpha=.2, color='Gold', size=10)
...
if nh > 0:
	...
	plot.line(hx, h1-0.4, alpha=.2, color='black', size=10)
	plot.circle(xphaseh, yh-0.4, alpha=.2, color='DarkOrange', size=10)
...
if nk > 0:
	...
	plot.line(kx, k1-0.8, alpha=.2, color='black', size=10)
	plot.circle(xphasek, yk-0.8, alpha=.2, color='Red', size=10)
...
if nir1 > 0:
	...
	plot.line(ir1x, ir1-1.4, alpha=.2, color='black', size=10)
	plot.circle(xphaseir1, yir1-1.4, alpha=.2, color='MediumVioletRed', size=10)
...
if nir2 > 0:
	...
	plot.line(ir2x, ir2-1.8, alpha=.2, color='black', size=10)
	plot.circle(xphaseir1, yir1-1.8, alpha=.2, color='DeepPink', size=10)
## For RRLyrae WISE plots:
